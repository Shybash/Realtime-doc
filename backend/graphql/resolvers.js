...
// Helper to assert document access
...
export const resolvers = {
  Query: {
    // Fetch all documents the user is allowed to access
    ...
    comments: async (_, { docId }, context) => {
      ...
      try {
        // Assert commenter / viewer access on the parent document
  ...
  Mutation: {
    ...
    deleteComment: async (_, { docId, commentId }, context) => {
      ...
      try {
        // Only admin/editor can delete comments
